const menuItems = [
  ...
  {id:"S02",cat:"set",jp:"ブンボーフエセット",vn:"Set Bún bò Huế",desc:"ブンボーフエ + ハーフバインミー + 揚げソーセージ1本",price:1350,image:"set-02.jpg"},
  ...
  grid.innerHTML = list.map(x => `
    <article class="menu-card ${x.cat}">
      <div class="card-image">
        <img src="${x.image}" alt="${x.jp}" loading="lazy" onerror="this.src='hero-banner.png'">
...
lightbox.addEventListener('click', (e) => {
  if (e.target === lightbox || e.target === btnClose) lightbox.classList.remove('active');
});
